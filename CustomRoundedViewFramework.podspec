Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedViewFramework"
  spec.version      = "0.0.1"
  ...
  spec.homepage     = "https://github.com/haicidar/CustomRounded.git"
  ...
  spec.author             = { "Muhammad Haidar Rais" => "haidattkj26@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/haicidar/CustomRounded.git", :tag => "#{spec.version}" }

	# Replace value of source file with your Path
  spec.source_files  = "CustomRoundedViewFramework/**/*.{swift}"
